...
# Railway uses proxy, so trust the X-Forwarded-Proto header
...
# Disable BrowsableAPIRenderer in production to avoid static file issues
# Only use JSONRenderer for API responses
REST_FRAMEWORK = {
