...
class TestPollCloning:
    ...
    def test_clone_poll_with_all_data(self, user):
        ...
        option1 = PollOption.objects.create(poll=original_poll, text="Option 1", order=0)
        option2 = PollOption.objects.create(poll=original_poll, text="Option 2", order=1)
        option3 = PollOption.objects.create(poll=original_poll, text="Option 3", order=2)
    ...
    def test_clone_poll_with_settings(self, user):
        ...
        original_poll = Poll.objects.create(
            title="Original",
            created_by=user,
            settings={"show_results_during_voting": True, "allow_multiple_votes": False},
